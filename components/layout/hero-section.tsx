...
import { Star, ShieldCheck, Crown, Code } from "lucide-react";
    ...
    <section className="bg-transparent py-12 px-4 md:px-0">
      <div className="container mx-auto grid md:grid-cols-2 gap-8 items-center">
        ...
        <div>
          ...
          <h1 className="text-3xl md:text-5xl font-bold mb-5 mt-5">Working Faster 10x</h1>
          <p className="text-gray-600 mb-6 text-sm md:text-base">
            Dolor si amet lorem super-power features richer than any other platform devices AI integrated.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            ...
            <Button variant="outline" className="rounded-full px-6 py-6 text-sm md:text-base">
              View Details
            </Button>
          </div>
        </div>
        ...
        <div className="relative flex justify-center">
          ...
          {/* Bonus Mac OS */}
          <div className="absolute bottom-2 left-2 flex items-center gap-2 bg-white px-3 py-2 rounded-2xl text-xs md:text-sm shadow">
          ...
          {/* Include Warranty */}
          <div className="absolute top-1/3 right-2 md:right-16 flex flex-col items-center gap-1 bg-white px-3 py-2 rounded-2xl text-xs md:text-sm shadow">
      ...
      {/* Reviews */}
      <div className="flex flex-wrap items-center justify-center gap-6 md:gap-8 mt-10 px-2">
